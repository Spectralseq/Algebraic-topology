...
\[\includegraphics[width=0.8\textwidth]{pictures/delta-complex.pdf}\]
...
\end{proof}
\begin{proof}[Proof of \cref{homology open cover}]
...
\begin{minipage}{200pt}
\centering
\includegraphics[width=0.8\textwidth]{pictures/cell-2}
